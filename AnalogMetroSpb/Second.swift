...
//        let stationParnas = Station(id: 1, name: "Парнас")
//        let parnasVertex = graph.createVertex(data: stationParnas)
//        drawSmallStations(name: stationParnas.name,x: 160,y: 24,color: .blue, id: stationParnas.id)
//        let stationProspect = Station(id: 2, name: "Проспект просвещения")
//        let prospectVertex = graph.createVertex(data: stationProspect)
//        drawSmallStations(name: stationProspect.name,x: 160,y: 54, color: .blue, id: stationProspect.id)
